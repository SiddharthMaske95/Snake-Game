...
snake_position = [90, 70]
snake_body = [[90, 70], [90, 70], [80, 70], [70, 70]]
...
def game_over():
    ...
    go_surface = font.render("YOUR SCORE IS " + str(score), True, green)
...
while True:
    ...
    for sb in snake_body:
        pygame.draw.rect(window, black, pygame.Rect(sb[0], sb[1], 20, 20))

    pygame.draw.rect(window, green, pygame.Rect(food_position[0], food_position[1], 20, 20))
